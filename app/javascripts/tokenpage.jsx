...
var TokenPage = React.createClass({
  ...
  componentDidMount: function() {
    ...
    //it is going to want to try and use NBS ABI, hoping that is this ERC20 version of the token.
    var web3_token = web3.eth.contract(NBS.abi).at(this.props.params.contract_address); //for reflux-tx
