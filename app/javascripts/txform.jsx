...
var TxForm = React.createClass({
  ...
  componentDidMount: function() {
    /*console.log(NBS.prototype);
    console.log(NBS.prototype.binary);*/
  },
  ...
  executeFunction: function() {
    ...
    if(typeof this.props.web3_token == 'undefined') {
      ...
      var ST = web3.eth.contract(NBS.abi);
      var tx_hash = null;
      var that = this;
      ...
      web3.eth.getAccounts(function(err, accounts){
        ...
        //var creation_data = ST.new.getData(args[0], args[1], args[2], args[3], {from: addr, data: "0x" + NBS.prototype.binary, gasPrice: 50000000000, gas: 3100000});

        ST.new(args[0], args[1], args[2], args[3], {from: addr, data: NBS.prototype.binary, gasPrice: 20000000000, gas: 1000000}, function(err, result) {
